...
export const LOADING_COPY = 'Apple Hide My Email — Loading...';
export const SIGNED_IN_CTA_COPY = 'Generate and reserve Hide My Email address';
export const NOTIFICATION_MESSAGE_COPY = 'Apple Hide My Email is ready to use!';
export const NOTIFICATION_TITLE_COPY = 'Apple Hide My Email';
